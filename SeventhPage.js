...
class SeventhPage extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      images: [
       require('./img/green1.png'),
       require('./img/green2.png'),
       require('./img/green3.png'),
       require('./img/green4.png'),
       require('./img/green5.png'),
      ],
      status: '',
    };
  }
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
          <Video
      style={styles.video}
      source={require('./assets/greenovation.mp4')}
      useNativeControls
      resizeMode="contain"
      isLooping
      onPlaybackStatusUpdate={this.state.status} />
       <View style={styles.container}>
      <Text style={styles.text}>Greenovation for a Blue Planet</Text>
      <Text style={styles.text1}>Source: Youtube (Mayuri Prasad) </Text>
        </View>
          </View>
          <View style={styles.container}>
        <Image style={{marginTop: 15}}source={require('./img/greentitle.png')} />
        </View>
      <View style={styles.container}>
        <SliderBox
