    ...
    render() {
      ...
      return (
        ...
        <View style={styles.container}>
            <Video
        style={styles.video}
        source={require('./assets/globalwarming.mp4')}
        useNativeControls
        resizeMode="contain"
        isLooping
        onPlaybackStatusUpdate={this.state.status} />
            <View style={styles.container}>
        <Text style={styles.text}>Causes and Effects of Climate Change</Text>
        <Text style={styles.text1}>Source: Youtube (National Geographic) </Text>
          </View>

            </View>
            <View style={styles.container}>
          <Image style={{marginTop: 15}}source={require('./img/gwtitle.png')} />
          </View>
        <View style={styles.container}>
          <SliderBox
