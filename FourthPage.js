...
class FourthPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      images: [
       require('./img/natprod1.png'),
       require('./img/natprod2.png'),
       require('./img/natprod3.png'),
      ],
      status: '',
    };
  }
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
          <Video
      style={styles.video}
      source={require('./assets/natprod.mp4')}
      useNativeControls
      resizeMode="contain"
      isLooping
      onPlaybackStatusUpdate={this.state.status} />
      <View style={styles.container}>
        <Text style={styles.text}>Plastics 101</Text>
          <Text style={styles.text1}>Source: Youtube (National Geographic) </Text>
          </View>
          </View>
          <View style={styles.container}>
        <Image style={{marginTop: 15}}source={require('./img/natprodtitle.png')} />
        </View>
      <View style={styles.container}>
        <SliderBox
